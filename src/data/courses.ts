...
export const courses: Course[] = [
  ...
  // ============================================
  {
    ...
    description:
      "Découvrez les bases de cette fascinante période historique qui a duré 1000 ans.",
...
La foi chrétienne structurait le quotidien : les fêtes religieuses rythmaient l'année, les sacrements marquaient les étapes de la vie.`,
  ...
  // ============================================
  {
    ...
    description:
      "Explorez les aspects plus complexes de cette période : croisades, commerce, et transformations sociales.",
    estimatedTime: 20,
    sections: [
      {
        id: "croisades",
...
• L'Angleterre perd presque tous ses territoires en France`,
  ...
  // ============================================
  {
    ...
    description:
      "Analysez les structures politiques, intellectuelles et artistiques de la fin du Moyen-Âge.",
    estimatedTime: 25,
    sections: [
      {
